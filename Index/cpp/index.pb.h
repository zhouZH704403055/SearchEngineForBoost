...
class DocInfo : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:doc_index_proto.DocInfo) */ {
 public:
  ...
  void clear_show_url();
  static const int kShowUrlFieldNumber = 5;
...
class Weight : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:doc_index_proto.Weight) */ {
 public:
  ...
  bool has_title_count() const;
  void clear_title_count();
  static const int kTitleCountFieldNumber = 3;
  ::google::protobuf::int32 title_count() const;
  void set_title_count(::google::protobuf::int32 value);

  // required int32 content_count = 4;
  bool has_content_count() const;
  void clear_content_count();
  static const int kContentCountFieldNumber = 4;
  ::google::protobuf::int32 content_count() const;
  void set_content_count(::google::protobuf::int32 value);

  // required int32 first_pos = 5;
  bool has_first_pos() const;
  void clear_first_pos();
  static const int kFirstPosFieldNumber = 5;
 ...
 private:
  ...
  void set_has_title_count();
  void clear_has_title_count();
  void set_has_content_count();
  void clear_has_content_count();
  ...
  ::google::protobuf::int32 title_count_;
  ::google::protobuf::int32 content_count_;
...
inline void Pair::set_has_begin() {
  _has_bits_[0] |= 0x00000001u;
}
inline void Pair::clear_has_begin() {
  _has_bits_[0] &= ~0x00000001u;
}
...
inline ::google::protobuf::int32 Pair::begin() const {
  // @@protoc_insertion_point(field_get:doc_index_proto.Pair.begin)
  return begin_;
}
inline void Pair::set_begin(::google::protobuf::int32 value) {
  set_has_begin();
  begin_ = value;
...
inline ::google::protobuf::int32 Pair::end() const {
  // @@protoc_insertion_point(field_get:doc_index_proto.Pair.end)
  return end_;
}
inline void Pair::set_end(::google::protobuf::int32 value) {
  set_has_end();
  end_ = value;
...
inline ::google::protobuf::uint64 DocInfo::doc_id() const {
  // @@protoc_insertion_point(field_get:doc_index_proto.DocInfo.doc_id)
  return doc_id_;
}
inline void DocInfo::set_doc_id(::google::protobuf::uint64 value) {
  set_has_doc_id();
  doc_id_ = value;
  // @@protoc_insertion_point(field_set:doc_index_proto.DocInfo.doc_id)
}
...
// required int32 title_count = 3;
inline bool Weight::has_title_count() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void Weight::set_has_title_count() {
  _has_bits_[0] |= 0x00000004u;
}
inline void Weight::clear_has_title_count() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void Weight::clear_title_count() {
  title_count_ = 0;
  clear_has_title_count();
}
inline ::google::protobuf::int32 Weight::title_count() const {
  // @@protoc_insertion_point(field_get:doc_index_proto.Weight.title_count)
  return title_count_;
}
inline void Weight::set_title_count(::google::protobuf::int32 value) {
  set_has_title_count();
  title_count_ = value;
  // @@protoc_insertion_point(field_set:doc_index_proto.Weight.title_count)
}

// required int32 content_count = 4;
inline bool Weight::has_content_count() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void Weight::set_has_content_count() {
  _has_bits_[0] |= 0x00000008u;
}
inline void Weight::clear_has_content_count() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void Weight::clear_content_count() {
  content_count_ = 0;
  clear_has_content_count();
}
inline ::google::protobuf::int32 Weight::content_count() const {
  // @@protoc_insertion_point(field_get:doc_index_proto.Weight.content_count)
  return content_count_;
}
inline void Weight::set_content_count(::google::protobuf::int32 value) {
  set_has_content_count();
  content_count_ = value;
  // @@protoc_insertion_point(field_set:doc_index_proto.Weight.content_count)
}
