...
// required int64 time_stamp = 2;
inline bool Request::has_time_stamp() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void Request::set_has_time_stamp() {
  _has_bits_[0] |= 0x00000004u;
}
inline void Request::clear_has_time_stamp() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void Request::clear_time_stamp() {
  time_stamp_ = GOOGLE_LONGLONG(0);
  clear_has_time_stamp();
}
inline ::google::protobuf::int64 Request::time_stamp() const {
  // @@protoc_insertion_point(field_get:doc_server_proto.Request.time_stamp)
  return time_stamp_;
}
inline void Request::set_time_stamp(::google::protobuf::int64 value) {
  set_has_time_stamp();
  time_stamp_ = value;
  // @@protoc_insertion_point(field_set:doc_server_proto.Request.time_stamp)
}
...
// required int64 time_stamp = 2;
inline bool Response::has_time_stamp() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void Response::set_has_time_stamp() {
  _has_bits_[0] |= 0x00000002u;
}
inline void Response::clear_has_time_stamp() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void Response::clear_time_stamp() {
  time_stamp_ = GOOGLE_LONGLONG(0);
  clear_has_time_stamp();
}
inline ::google::protobuf::int64 Response::time_stamp() const {
  // @@protoc_insertion_point(field_get:doc_server_proto.Response.time_stamp)
  return time_stamp_;
}
inline void Response::set_time_stamp(::google::protobuf::int64 value) {
  set_has_time_stamp();
  time_stamp_ = value;
  // @@protoc_insertion_point(field_set:doc_server_proto.Response.time_stamp)
}
